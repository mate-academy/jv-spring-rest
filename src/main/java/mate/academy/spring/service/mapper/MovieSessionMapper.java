...
public class MovieSessionMapper {
    ...
    public MovieSessionMapper(MovieService service, CinemaHallService cinemaHallService) {
    ...
    public MovieSession toModel(MovieSessionRequestDto dto, Long id) {
        MovieSession movieSession = toModel(dto);
