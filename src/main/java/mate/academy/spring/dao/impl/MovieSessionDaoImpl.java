...
public class MovieSessionDaoImpl extends AbstractDao<MovieSession> implements MovieSessionDao {
    ...
    public MovieSession update(MovieSession movieSession) {
        ...
        try {
            ...
            throw new DataProcessingException("Couldn't update movie session with param: "
                    + movieSession, e);
        } finally {
            if (session != null) {
                session.close();
    ...
    public void delete(Long id) {
        ...
        try {
            ...
            throw new DataProcessingException("Couldn't delete movie session with id: " + id, e);
        } finally {
            if (session != null) {
                session.close();
            }
