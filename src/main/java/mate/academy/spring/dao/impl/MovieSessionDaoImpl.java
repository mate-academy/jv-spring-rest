...
public class MovieSessionDaoImpl extends AbstractDao<MovieSession> implements MovieSessionDao {
    ...
    public MovieSession update(MovieSession movieSession) {
        ...
        try {
            ...
            throw new DataProcessingException("Can not update movieSession: " + movieSession, e);
        } finally {
            if (session != null) {
                session.close();
            }
    ...
    public MovieSession delete(MovieSession movieSession) {
        ...
        try {
            ...
            throw new DataProcessingException("Can not delete movieSession: " + movieSession, e);
        } finally {
            if (session != null) {
                session.close();
            }
