...
public class MovieSessionDaoImpl extends AbstractDao<MovieSession> implements MovieSessionDao {
    ...
    public MovieSession update(MovieSession movieSession) {
        ...
        try {
            ...
            throw new DataProcessingException("Cannot update a movie session " + movieSession, e);
        } finally {
            if (session != null) {
                session.close();
            }
    ...
    public void delete(MovieSession movieSession) {
        ...
        try {
            ...
            throw new DataProcessingException("Cannot delete a movie session " + movieSession, e);
        } finally {
            if (session != null) {
                session.close();
            }
