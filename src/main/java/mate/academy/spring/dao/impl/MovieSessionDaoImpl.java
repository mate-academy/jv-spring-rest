...
public class MovieSessionDaoImpl extends AbstractDao<MovieSession> implements MovieSessionDao {
    ...
    @Override
    public MovieSession upgrade(MovieSession movieSession) {
        ...
        try {
            ...
            throw new DataProcessingException("Can't upgrade movie session" + movieSession, e);
        } finally {
            if (session != null) {
                session.close();
            }
    ...
    public void delete(Long id) {
        ...
        try {
            ...
            throw new DataProcessingException("Can't delete movie session by this id: " + id, e);
        } finally {
            if (session != null) {
                session.close();
            }
