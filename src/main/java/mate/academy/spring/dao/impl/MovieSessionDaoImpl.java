...
public class MovieSessionDaoImpl extends AbstractDao<MovieSession> implements MovieSessionDao {
    ...
    public MovieSession update(MovieSession movieSession) {
        ...
        try {
            ...
            throw new DataProcessingException("Can't update " + movieSession.getClass()
                    .getSimpleName() + ": " + movieSession, e);
        } finally {
            if (session != null) {
                session.close();
            }
    ...
    public void delete(MovieSession movieSession) {
        ...
        try {
            ...
            throw new DataProcessingException("Can't delete " + movieSession.getClass()
                    .getSimpleName() + ": " + movieSession, e);
        } finally {
            if (session != null) {
                session.close();
