...
public class MovieSessionDaoImpl extends AbstractDao<MovieSession> implements MovieSessionDao {
    ...
    public Optional<MovieSession> update(MovieSession movieSession) {
        ...
        try {
            ...
            throw new DataProcessingException("Cannot update movieSession " + movieSession, e);
        } finally {
            if (session != null) {
                session.close();
            }
    ...
    public void delete(MovieSession movieSession) {
        ...
        try {
            ...
            throw new DataProcessingException("Cannot delete movieSession cart " + movieSession, e);
        } finally {
            if (session != null) {
                session.close();
            }
