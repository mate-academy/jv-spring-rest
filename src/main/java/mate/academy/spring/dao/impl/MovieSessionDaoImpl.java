...
public class MovieSessionDaoImpl extends AbstractDao<MovieSession> implements MovieSessionDao {
    ...
    public void delete(Long id) {
        ...
        try {
            ...
            throw new DataProcessingException("Cant delete movie session from db by id: " + id, e);
        } finally {
            if (session != null) {
                session.close();
            }
    ...
    public MovieSession update(MovieSession movieSession) {
        ...
        try {
            ...
            throw new DataProcessingException("Cant update movieSession " + movieSession, e);
        } finally {
            if (session != null) {
                session.close();
            }
