...
public class MovieSessionDaoImpl extends AbstractDao<MovieSession> implements MovieSessionDao {
    ...
    public boolean delete(Long id) {
        ...
        try {
            ...
            Query query = session.createQuery("delete from MovieSession where id = :id");
            ...
            throw new DataProcessingException("Couldn't delete a movie session dy id = " + id, e);
        } finally {
            if (session != null) {
                session.close();
            }
    ...
    public MovieSession update(MovieSession movieSession) {
        ...
        try {
            ...
            throw new DataProcessingException("Couldn't update a movie session = "
                    + movieSession, e);
        } finally {
            if (session != null) {
                session.close();
