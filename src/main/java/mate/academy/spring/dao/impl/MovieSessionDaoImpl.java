...
public class MovieSessionDaoImpl extends AbstractDao<MovieSession> implements MovieSessionDao {
    ...
    public MovieSession add(MovieSession movieSession) {
        ...
        try {
            ...
            throw new DataProcessingException("Can't insert movie session: " + movieSession, ex);
        } finally {
            if (session != null) {
                session.close();
            }
    ...
    public MovieSession update(MovieSession movieSession) {
        ...
        try {
            ...
            throw new DataProcessingException("Can't update movie session: " + movieSession, ex);
        } finally {
            if (session != null) {
                session.close();
            }
    ...
    public void delete(MovieSession movieSession) {
        ...
        try {
            ...
            throw new DataProcessingException("Can't delete movie session: " + movieSession, ex);
        } finally {
            if (session != null) {
                session.close();
            }
