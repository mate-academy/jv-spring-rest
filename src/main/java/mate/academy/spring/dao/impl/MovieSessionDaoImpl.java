...
public class MovieSessionDaoImpl extends AbstractDao<MovieSession> implements MovieSessionDao {
    ...
    public MovieSession update(MovieSession movieSession) {
        ...
        try {
            ...
            throw new DataProcessingException("Couldn't update session " + movieSession, e);
        } finally {
            if (session != null) {
                session.close();
            }
    ...
    public void delete(Long id) {
        ...
        try {
            session = sessionFactory.openSession();
            transaction = session.beginTransaction();
            MovieSession movieSession = session.find(MovieSession.class, id);
            ...
            throw new DataProcessingException("Couldn't delete session bu id " + id, e);
        } finally {
            if (session != null) {
                session.close();
            }
