...
public class CinemaHallController {
    ...
    @PostMapping
    public CinemaHallResponseDto create(@RequestBody CinemaHallRequestDto cinemaHallFromRequest) {
        CinemaHall cinemaHall = cinemaHallDtoMapper.toModel(cinemaHallFromRequest);
