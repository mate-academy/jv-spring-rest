...
public class MovieSessionController {
    ...
    public MovieSessionResponseDto add(
        ...
        return mapper.parseToDto(movieSessionService.add(
                mapper.parseToModel(movieSessionRequestDto)));
    }
    ...
    public MovieSessionResponseDto update(@PathVariable Long id,
        ...
        MovieSession movieSession = mapper.parseToModel(sessionRequestDto);
        movieSession.setId(id);
        return mapper.parseToDto(movieSessionService.update(movieSession));
    }

    @DeleteMapping("/{id}")
    public MovieSessionResponseDto delete(@PathVariable Long id) {
        return mapper.parseToDto(movieSessionService.delete(id));
    }
}
