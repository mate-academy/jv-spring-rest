...
public class MovieSessionController {
    ...
    public MovieSessionResponseDto add(@RequestBody MovieSessionRequestDto movieSessionRequestDto) {
        return movieSessionResponseMapper
                .toDto(movieSessionService
                        .add(movieSessionRequestMapper
    ...
    public List<MovieSessionResponseDto> getAllAvailableSessions(
        ...
        return movieSessionService.findAvailableSessions(movieId, date)
                .stream().map(movieSessionResponseMapper::toDto)
    ...
    public MovieSessionResponseDto update(
        ...
        MovieSession movieSession = movieSessionRequestMapper.fromDto(movieSessionRequestDto);
