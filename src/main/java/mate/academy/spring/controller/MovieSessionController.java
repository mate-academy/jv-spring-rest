...
public class MovieSessionController {
    ...
    @PostMapping
    public MovieSessionResponseDto createMovieSession(@RequestBody MovieSessionRequestDto
    ...
    public List<MovieSessionResponseDto> findAll(@RequestParam Long movieId,
                                                 @RequestParam
                                                 @DateTimeFormat(pattern = "dd.MM.yyyy")
                                                 LocalDate date) {
        return movieSessionService.findAvailableSessions(movieId, date).stream()
                .map(movieSessionMapper::toDto).toList();
    }
