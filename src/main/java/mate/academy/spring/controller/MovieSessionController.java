...
public class MovieSessionController {
    ...
    public MovieSessionResponseDto add(@RequestBody MovieSessionRequestDto movieSessionRequestDto) {
        MovieSession movieSession = movieSessionMapper.convert(movieSessionRequestDto);
        return movieSessionMapper.parse(movieSessionService.add(movieSession));
    }
    ...
    public void delete(@RequestBody Long movieSessionId) {
        movieSessionService.delete(movieSessionService.get(movieSessionId));
    }
}
