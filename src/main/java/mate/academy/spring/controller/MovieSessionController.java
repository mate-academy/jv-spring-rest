...
public class MovieSessionController {
    ...
    @PostMapping
    public MovieSessionResponseDto addMovieSession(@RequestBody MovieSessionRequestDto
    ...
    @PutMapping("/{id}")
    public MovieSessionResponseDto updateMovieSession(@RequestBody Long id,
