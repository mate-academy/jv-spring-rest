...
public class MovieSessionController {
    ...
    public MovieSessionResponseDto create(@RequestBody MovieSessionRequestDto requestDto) {
        return mapper.toDto(movieSessionService.add(mapper.toMovieSession(requestDto)));
    }

    @GetMapping("/available")
    public List<MovieSessionResponseDto> getAllOnDate(@RequestParam Long movieId,
                                                       @RequestParam
    ...
    public MovieSessionResponseDto update(@PathVariable Long id,
        ...
        MovieSession movieSession = mapper.toMovieSession(requestDto);
