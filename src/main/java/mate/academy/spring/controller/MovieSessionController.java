...
public class MovieSessionController {
    ...
    public MovieSessionResponseDto create(@RequestBody MovieSessionRequestDto movieSession) {
        return movieSessionDtoMapper.toDto(
                movieSessionService.add(movieSessionDtoMapper.toModel(movieSession)));
    }

    @GetMapping("/available")
    public List<MovieSessionResponseDto> findAvailableMovieSession(
    ...
    public void delete(@PathVariable Long id) {
        MovieSession movieSessionFromDb = movieSessionService.get(id);
        movieSessionService.delete(movieSessionFromDb);
    }
}
