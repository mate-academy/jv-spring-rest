...
public class MovieSessionController {
    ...
    @PostMapping
    public MovieSessionResponceDto create(@RequestBody MovieSessionRequestDto
    ...
    public List<MovieSessionResponceDto> getAllAvailable(@RequestParam Long movieId, @RequestParam
