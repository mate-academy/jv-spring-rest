...
import mate.academy.spring.model.dto.requests.MovieSessionRequestDto;
import mate.academy.spring.model.dto.responses.MovieSessionResponseDto;
...
public class MovieSessionController {
    ...
    public MovieSessionResponseDto create(@RequestBody MovieSessionRequestDto movieSession) {
        return movieSessionMapper
            .parseToResponseDto(movieSessionService.add(movieSessionMapper.toModel(movieSession)));
    }
