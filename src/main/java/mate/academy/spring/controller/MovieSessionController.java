...
public class MovieSessionController {
    ...
    public List<MovieSessionResponseDto> getMovieSessionByIdAndDate(@RequestParam Long movieId, @RequestParam @DateTimeFormat(pattern = "dd.MM.yyyy") LocalDate date) {
